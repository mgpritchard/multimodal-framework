...
if __name__ == '__main__':
    ...
    load_res_path=r"C:\Users\pritcham\Documents\mm-framework\multimodal-framework\lit_data_expts\jeong\results\RQ3\HO2_withinSeshOptHalfPrior_final_resMinimal.csv"
    
    #systemUnderTest = 'HO1_withinSeshFully'
    
    systemUnderTest = 'HO2_withinSeshOptHalfPrior'
 
    
    if systemUnderTest=='HO1_withinSeshFully':
        '''proably cant do with this script'''
    ...
    elif systemUnderTest == 'HO2_withinSeshOptHalfPrior':
        feats_method='no calib'
        opt_method='no calib'
        train_method='calib'
    ...
    elif systemUnderTest=='HO0_both1and2':
        '''possibly cant do with this script'''
        train_session='both'
        feats_method='no calib'
        opt_method='no calib'
        train_method='no calib'
    ...
    if run_test:
        ...
        for idx,ppt in enumerate(holdout_ppts):
            print('Subject ',str(idx+1),' of 5 holdouts')
            ...
            for repeat in range (n_repeats):
                ...
                if train_session=='first':
                    ...
                    if systemUnderTest=='HO2_withinSeshOptHalfPrior':
