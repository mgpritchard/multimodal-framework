...
class Rawfile:
    ...
    def __repr__(self):
        return(f'{self.__class__.__name__}('
               f'{self.ppt!r}, {self.label!r}, {self.count!r})')
...
def sync_raw_files(raw_emg_list,raw_eeg_list,crop_emg_dir,crop_eeg_dir):
    for emgfile in raw_emg_list:
        ...
        np.savetxt(build_path(crop_emg_dir,eegfile),crop_eeg,delimiter=',')
...
def whole_pipeline():
    ...
    sync_raw_files(raw_emg_list,raw_eeg_list,crop_emg_dir,crop_eeg_dir)