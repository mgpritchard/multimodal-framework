...
if __name__ == '__main__':
    ...
    load_res_path=r"C:\Users\pritcham\Documents\mm-framework\multimodal-framework\lit_data_expts\jeong\results\RQ3\HO4_XferFromGen_final_resMinimal.csv"
    
    
    systemUnderTest = 'HO4_XferFromGen'
    
    testset_size = 0.33
        
    if systemUnderTest == 'HO4_XferFromGen':
    ...
    if run_test:
        ...
        emg_others_path=params.jeong_emg_noholdout
        eeg_others_path=params.jeong_eeg_noholdout
        
        emg_others=ml.pd.read_csv(emg_others_path,delimiter=',')
        eeg_others=ml.pd.read_csv(eeg_others_path,delimiter=',')
