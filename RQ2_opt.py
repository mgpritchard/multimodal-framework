...
def train_svm_fuser(model_emg,model_eeg,emg_set,eeg_set,classlabels,args,sel_cols_eeg,sel_cols_emg):
    ...
    if not args['stack_distros']:
        ...
        onehot_pred_emg=fusion.encode_preds_onehot(predlist_emg,onehot)
        onehot_pred_eeg=fusion.encode_preds_onehot(predlist_eeg,onehot)
        fuser=fusion.train_svm_fuser(onehot_pred_emg, onehot_pred_eeg, targets, args['fusion_alg'])
    else:
        onehot=None
        fuser=fusion.train_svm_fuser(distros_emg, distros_eeg, targets, args['fusion_alg'])
    return fuser, onehot
...
def train_lda_fuser(model_emg,model_eeg,emg_set,eeg_set,classlabels,args,sel_cols_eeg,sel_cols_emg):
    ...
    if not args['stack_distros']:
        ...
        onehot_pred_emg=fusion.encode_preds_onehot(predlist_emg,onehot)
        onehot_pred_eeg=fusion.encode_preds_onehot(predlist_eeg,onehot)
        fuser=fusion.train_lda_fuser(onehot_pred_emg, onehot_pred_eeg, targets, args['fusion_alg'])
    else:
        onehot=None
        fuser=fusion.train_lda_fuser(distros_emg, distros_eeg, targets, args['fusion_alg'])
    return fuser, onehot
...
def train_RF_fuser(model_emg,model_eeg,emg_set,eeg_set,classlabels,args,sel_cols_eeg,sel_cols_emg):
    ...
    if not args['stack_distros']:
        ...
        onehot_pred_emg=fusion.encode_preds_onehot(predlist_emg,onehot)
        onehot_pred_eeg=fusion.encode_preds_onehot(predlist_eeg,onehot)
        fuser=fusion.train_rf_fuser(onehot_pred_emg, onehot_pred_eeg, targets, args['fusion_alg'])
    else:
        onehot=None
        fuser=fusion.train_rf_fuser(distros_emg, distros_eeg, targets, args['fusion_alg'])
    return fuser, onehot
...
def fusion_SVM(emg_train, eeg_train, emg_test, eeg_test, args):
    ...
    if not args['stack_distros']:
        ...
        fuser=fusion.train_svm_fuser(onehot_pred_emg, onehot_pred_eeg, fustargets, args['fusion_alg'])
    else:
        onehotEncoder=None
...
def fusion_LDA(emg_train, eeg_train, emg_test, eeg_test, args):
    ...
    if not args['stack_distros']:
        ...
        onehot_pred_emg=fusion.encode_preds_onehot(fusdistros_emg,onehotEncoder)
        onehot_pred_eeg=fusion.encode_preds_onehot(fusdistros_eeg,onehotEncoder)
        fuser=fusion.train_lda_fuser(onehot_pred_emg, onehot_pred_eeg, fustargets, args['fusion_alg'])
    else:
        onehotEncoder=None
...
def fusion_RF(emg_train, eeg_train, emg_test, eeg_test, args):
    ...
    if not args['stack_distros']:
        ...
        onehot_pred_emg=fusion.encode_preds_onehot(fusdistros_emg,onehotEncoder)
        onehot_pred_eeg=fusion.encode_preds_onehot(fusdistros_eeg,onehotEncoder)
        fuser=fusion.train_rf_fuser(onehot_pred_emg, onehot_pred_eeg, fustargets, args['fusion_alg'])
    else:
        onehotEncoder=None
...
def plot_stat_in_time(trials,stat,ylower=0,yupper=1,showplot=True):
    ...
    # Plot something showing which were which models? eg with vertical fill
